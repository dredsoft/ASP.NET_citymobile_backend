...
namespace CityApp.Data.Migrations.Account
{
    ...
    [Migration("20180320023619_boundaryOrderFK")]
    partial class boundaryOrderFK
    {
            ...
            modelBuilder.Entity("CityApp.Data.Models.EventViolationPrice", b =>
                {
                    ...
                    b.HasOne("CityApp.Data.Models.Violation")
                        .WithMany("EventViolationPrices")
                        .HasForeignKey("ViolationId1");
                });
